document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectDetails = {
        ...
        "automatizacao-backups": {
            ...
            year: "2024-1",
            partner: "DEEPESG",
            description: "Realizei a automatização de backups de empresa criando um script que acessava a API da AWS e enviava toda semana um email informando se a verificação foi realizada e quais empresas foram verificadas solucionando o problema em que oss backups eram validados manualmente, aumentando o custo de tempo e insegurança na assertividade da validação dessa verificações. ",
        ...
        "offboarding": {
            ...
            year: "2024-2",
            partner: "DEEPESG",
            description: "Desenvolvi um programa que realiza o processo de offboarding de um colaborador automaticamente realizando um fluxo de agendamento automático de uma planilha que engatilha o programa.",
